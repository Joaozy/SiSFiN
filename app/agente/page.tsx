...
export default function AgentePage() {
  ...
  return (
    <main className="flex flex-col h-[calc(100vh-4rem)] max-w-5xl mx-auto p-4">
      {/* Header melhorado com ícone de robô */}
      <div className="mb-4">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm ml-16">
          Fale naturalmente para registrar despesas e receitas
        </p>
      </div>

      {/* Chat messages com GLASSMORPHISM INTENSO */}
        ...
        {messages.length === 0 && (
          <div className="text-center text-gray-500 dark:text-gray-400 mt-8 animate-fade-in">
            ...
            <p className="text-sm mb-6">
              Posso ajudar a registrar despesas e receitas, validar comprovantes e consultar seus dados.
            </p>
            <div className="inline-flex flex-col gap-2 text-xs text-gray-600 dark:text-gray-400 bg-white/50 dark:bg-gray-700/50 rounded-xl p-4 backdrop-blur-sm">
              <p>💬 "Gastei 50 reais em gasolina"</p>
              <p>📸 Envie uma foto do comprovante</p>
              <p>💰 "Vendi um serviço de 850 reais"</p>
            </div>
          </div>
        )}
