  ...
  return (
    ...
    >
      ...
      <p className="text-3xl sm:text-4xl font-bold break-all">
        {/* Alterado para pt-BR e adicionado estilo de moeda se desejar, mas mantendo raw number formatado como no original */}
